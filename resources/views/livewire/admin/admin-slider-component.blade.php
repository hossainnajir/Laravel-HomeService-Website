                                    ...
                                    @foreach($slides as $slide)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" onclick="confirm('Are you sure, you want to delete this slide?') || event.stopImmediatePropagation()" wire:click.prevent="deleteSlide({{$slide->id}})" style="margin-left:10px;" class="fa fa-times fa-2x text-danger"></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
