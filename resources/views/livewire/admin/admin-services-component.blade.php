                                    ...
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" onclick="confirm('Are you sure, you want to delete this service?') || event.stopImmediatePropagation()" wire:click.prevent="deleteService({{$service->id}})" style="margin-left:10px;" class="fa fa-times fa-2x text-danger"></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
