...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/style.css')); ?>" rel="stylesheet" media="screen">
    <link href="<?php echo e(asset('assets/css/chblue.css')); ?>" rel="stylesheet" media="screen">
    <link href="<?php echo e(asset('assets/css/theme-responsive.css')); ?>" rel="stylesheet" media="screen">
    <link href="<?php echo e(asset('assets/css/dtb/jquery.dataTables.min.css')); ?>" rel="stylesheet" media="screen">
    <link href="<?php echo e(asset('assets/css/select2.min.css')); ?>" rel="stylesheet" media="screen">
    <link href="<?php echo e(asset('assets/css/toastr.min.css')); ?>" rel="stylesheet" media="screen">        
    <script type="text/javascript" src="<?php echo e(asset('assets/js/jquery.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/jquery-ui.1.10.4.min.js')); ?>"></script>
        ...
        <div class="info-head">
            <div class="container">
                <div class="row">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('location-component')->html();
} elseif ($_instance->childHasBeenRendered('We4SeVT')) {
    $componentId = $_instance->getRenderedChildComponentId('We4SeVT');
    $componentTag = $_instance->getRenderedChildComponentTagName('We4SeVT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('We4SeVT');
} else {
    $response = \Livewire\Livewire::mount('location-component');
    $html = $response->html();
    $_instance->logRenderedChild('We4SeVT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="<?php echo e(route('home.service_categories')); ?>">Service Categoris</a></li>
                    ...
                    <?php if(Route::has('login')): ?>
                            ...
                            <?php if(Auth::user()->utype === 'ADM'): ?>
                                <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="<?php echo e(route('admin.service_categories')); ?>">Service Categories</a></li>
                                        <li><a href="<?php echo e(route('admin.all_services')); ?>">All Services</a></li>
                                        <li><a href="<?php echo e(route('admin.slider')); ?>">Manage Slider</a></li>
                                        <li><a href="<?php echo e(route('admin.contacts')); ?>">All Contacts</a></li>
                                        <li><a href="<?php echo e(route('admin.service_providers')); ?>">All Service Providers</a></li>
                            ...
                            <?php elseif(Auth::user()->utype === 'SVP'): ?>
                                <li class="login-form"> <a href="#" title="Register">My Account (S Provider)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="<?php echo e(route('sprovider.profile')); ?>">Profile</a></li>
                                        <li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                    </ul>
                                </li>
                            <?php else: ?>
                        ...
                        <?php else: ?>
                            <li class="login-form"> <a href="<?php echo e(route('register')); ?>" title="Register">Register</a></li>
                            <li class="login-form"> <a href="<?php echo e(route('login')); ?>" title="Login">Login</a></li>
                        <?php endif; ?>
                    <?php endif; ?>                 
                    <li class="search-bar">
                    </li>
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/js/nav/jquery.sticky.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/totop/jquery.ui.totop.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/accordion/accordion.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/rs-plugin/js/jquery.themepunch.tools.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/rs-plugin/js/jquery.themepunch.revolution.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/maps/gmap3.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/fancybox/jquery.fancybox.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/carousel/carousel.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/filters/jquery.isotope.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/twitter/jquery.tweet.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/flickr/jflickrfeed.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/theme-options/theme-options.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/theme-options/jquery.cookies.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/bootstrap/bootstrap.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/bootstrap/bootstrap-slider.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/dtb/jquery.dataTables.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/dtb/jquery.table2excel.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/dtb/script.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/select2.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/jquery.validate.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/validation-rule.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/bootstrap3-typeahead.min.js')); ?>"></script>
...
</html><?php /**PATH F:\New folder\HomeServices\resources\views/layouts/base.blade.php ENDPATH**/ ?>