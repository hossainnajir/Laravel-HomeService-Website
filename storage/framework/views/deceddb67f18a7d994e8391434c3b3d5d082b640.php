...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('images/services/thumbnails')); ?>/<?php echo e($thumbnail); ?>" width="60">    
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('images/services')); ?>/<?php echo e($image); ?>" width="60">      
                                                <?php endif; ?>
                                            </div>
                                        </div>
...
<?php /**PATH F:\New folder\HomeServices\resources\views/livewire/admin/admin-edit-service-component.blade.php ENDPATH**/ ?>